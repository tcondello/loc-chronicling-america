...
ExecStart=/home/ubuntu/loc-chronicling-america/.venv/bin/python -u scripts/run_multi_state_pipeline.py --high-value-36h --purge-local-after-upload --retry-failed
Restart=always
RestartSec=15
