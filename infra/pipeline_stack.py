    ...
    def __init__(
        ...
        **kwargs,
        ...
        user_data.add_commands(
            ...
            "apt-get update -y",
            "apt-get install -y git python3 python3-pip python3-venv tmux curl bzip2 htop amazon-cloudwatch-agent",
            "",
            ...
            "sudo -u ubuntu \"${APP_DIR}/.venv/bin/pip\" install -e \"${APP_DIR}[pipeline]\"",
            "",
